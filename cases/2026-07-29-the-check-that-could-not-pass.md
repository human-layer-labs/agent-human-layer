...
Chapter 1 contributed nothing here, because **nothing ever broke**. There was no bad state to
...
Chapter 1 makes broken work cheap to undo. It says nothing about work that was never broken
...
This case is the origin of Chapter 3: [The Unrun Check](../UNRUN-CHECKS.md).
