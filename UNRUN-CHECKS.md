...
This chapter extends it, as ["Cheap Enough to Die"](./CHEAP-DEATH.md) does. It is not a second trunk.*
...
The trunk governs **code**: make it cheap to restore.
"Cheap Enough to Die" governs **beliefs**: make them cheap to kill.
...
## The failure the trunk cannot price
...
The trunk asks *can we undo it?* For this class the answer is yes, trivially,
...
been executed, they are exactly what "Cheap Enough to Die" warned about: an assertion about
the world that has never been allowed to collide with the world.

"Cheap Enough to Die" said an unwritten belief can only be refuted by building the software.
